...
public class SavedReports extends BaseMethod{
	...
	public void Validate_portfolioSelection(Object obj) throws Throwable {
		...
		loginLandingReg.viewSavedReports(Testdatas.get("Test case_03"));
	
		reportPageReg.SaveReport1();
		gen.Get_Parentwindow_CloseCurrentWindow1();
		driver.switchTo().frame(0);
		loginLandingReg.viewSavedReports1(Testdatas.get("Test case_04"));
