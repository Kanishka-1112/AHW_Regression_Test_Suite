...
public class ReportPageReg_2M extends BaseMethod {
...
//Download as Refreshable File
	...
	public void download_AsAdvanced() {
		try {
			...
			Thread.sleep(5000);
			log.info("Downloaded as Advanced refreshable format of report");
			System.out.println("Downloaded Advanced refreshable format  of report");
		} catch (Exception e) {
			System.out.println("exception occured" + e);
			logger.log(Status.FAIL, " Exception ocuerd " + e);
		}
	...
	public void download_AsAdvancedStatic() {
		try {
			...
			Thread.sleep(5000);
			log.info("Downloaded as Advanced Static format of report");
			System.out.println("Downloaded as Advanced Static format of report");
		} catch (Exception e) {
			System.out.println("exception occured" + e);
			logger.log(Status.FAIL, " Exception ocuerd " + e);
		}
