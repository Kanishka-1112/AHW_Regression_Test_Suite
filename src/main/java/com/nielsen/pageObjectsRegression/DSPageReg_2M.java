...
public class DSPageReg_2M extends BaseMethod {
   ...
   // Period Selections
	...
	public void product_Characteristics() {
		try {
			...
			gen.click(ProdChar_Folder);
			Thread.sleep(2000);
			gen.doubleClick(ProdChar_folder1_middlepane1);
			gen.doubleClick(ProdChar_folder1_middlepane2);
			Thread.sleep(2000);
...
//2M Selection
	...
	public void productSelection_2M() {
		try {
			gen.click(prodDim);
			gen.click(prodTab);
			gen.click(prodHier_Folder);
		    ...
		    gen.click(prodHier_subFolder);
			action.moveToElement(prodHier_subFolder1).build().perform();
			gen.click(prodHier_subFolder1);
			Thread.sleep(3000);
			gen.doubleClick(prod_middlePane_1Item);
			//Clicking on All 
			gen.click(prodHier_subFolder10);
			Thread.sleep(3000);
		    gen.click(prod_hier_subFolder_All);
		    Thread.sleep(1000);
		    gen.doubleClick(prod_middlePane_1Item);
	...
	public void marketSelection_10M() {
		try {
			gen.click(mktDim);
			gen.click(mktTab);
			gen.click(mktGrp);
	...
	public void productSelection_10M() {
		try {
			gen.click(prodDim);
			gen.click(prodTab);
			gen.click(prodHier_Folder);
		    ...
		    Thread.sleep(1000);
		    //gen.doubleClick(prod_middlePane_1Item);
		    action.moveToElement(prodhierUpdateBtn).build().perform();
			gen.doubleClick(prodhierUpdateBtn);
			logger.log(Status.PASS, "Product selection done");
			System.out.println("Product selection done");
	...
	//Period 2M Selections
	public void periodSelection_2M() {
		try {
			gen.click(periodDim);
			gen.click(periodGrp);
			action.moveToElement(periodFolder).build().perform();
			...
			gen.doubleClick(per_middlePane_3Item);
			gen.doubleClick(per_middlePane_4Item);
			gen.doubleClick(per_middlePane_5Item);
			gen.doubleClick(per_middlePane_6Item);
			gen.doubleClick(per_middlePane_7Item);
			gen.doubleClick(per_middlePane_8Item);
			gen.doubleClick(per_middlePane_9Item);
			gen.doubleClick(per_middlePane_10Item);
			Thread.sleep(2000);
			logger.log(Status.PASS, "period selection done");
			System.out.println("period selection done");
	...
	public void periodSelection_10M() {
		try {
			gen.click(periodDim);
			gen.click(periodGrp);
			action.moveToElement(periodFolder).build().perform();
	...
	public void factSelection_10M() {
		try {
			gen.click(factDim);
			gen.click(factGrp);
			gen.click(factFolder);
			action.moveToElement(fact_subFolder1).build().perform();
			gen.click(fact_subFolder1);
			Thread.sleep(2000);
	...
	public void DSPage_Run() {
		try {
			// clicking apply button
			wait.until(ExpectedConditions.visibilityOf(RunReport));
			if (RunReport.isEnabled()) {
				System.out.println("RunReport button is enabled");
				action.moveToElement(RunReport).build().perform();
				action.click(RunReport).build().perform();
				Thread.sleep(3000);
				logger.log(Status.PASS, "RunReport is clicked");
				System.out.println("RunReport is clicked");
			}
		} catch (Exception e) {
			System.out.println("exception occured" + e);
			logger.log(Status.FAIL, " Exception ocuerd " + e);
